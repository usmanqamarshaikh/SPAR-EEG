...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the paired SPAR-EEG EMG geometry study.")
    parser.add_argument("--stage", choices=["prepare", "restore", "analyze", "all"], default="all")
    parser.add_argument("--result-tag", default="artifact_geometry_emg_minus10_n500")
...
def main() -> None:
    ...
    data_file = result_root / "data" / "emg_geometry_minus10.h5"
    restored_file = result_root / "restored" / "emg_geometry_minus10_restored.h5"
    analysis_dir = result_root / "analysis"
    diagnostics_file = analysis_dir / "artifact_geometry_stage_diagnostics.csv"
    ...
    print(f"\nArtifact-geometry workflow complete: {result_root}")
